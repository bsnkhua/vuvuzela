...
app:
	...
	cp Resources/goal.caf "$(DIST)/Contents/Resources/goal.caf"
	cp Resources/start.caf "$(DIST)/Contents/Resources/start.caf"
	cp Resources/finish.caf "$(DIST)/Contents/Resources/finish.caf"
